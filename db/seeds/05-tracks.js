  ...
  return knex('tracks').del()
    .then(function () {
      ...
      return knex('tracks').insert([
        ...
        {id: 12, user_id: 12, title: 'Salt For Your Wounds', artist_name: 'AFI', user_contr: 'man, we used to be so good!', url: `https://s3-us-west-2.amazonaws.com/bandolier-tracks/afi_saltforyourwounds.mp3`},
        ...
        {id: 15, user_id: 15, title: 'Run With The Wolves', artist_name: 'The Prodigy', user_contr: 'this drummer just played a bunch of drum stuff and sent it to me. turned out pretty wicked i guess', url: `https://s3-us-west-2.amazonaws.com/bandolier-tracks/prodigy_runwiththewolves.mp3`},
