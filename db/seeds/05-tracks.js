  ...
  return knex('tracks').del()
    .then(function () {
      ...
      return knex('tracks').insert([
        ...
        {id: 8, user_id: 8, url: `https://s3-us-west-2.amazonaws.com/bandolier-tracks/elevator_music.mp3`},
        ...
        {id: 12, user_id: 12, title: 'Run With The Wolves', artist_name: 'The Prodigy', user_contr: 'this drummer just played a bunch of drum stuff and sent it to me. turned out pretty wicked i guess', url: `https://s3-us-west-2.amazonaws.com/bandohttps://s3-us-west-2.amazonhttps://s3-us-west-2.amazonaws.com/bandolier-tracks/turnstile_blues.mp3aws.com/bandolier-tracks/turnstile_blues.mp3lier-tracks/prodigy_runwiththewolves.mp3`},
