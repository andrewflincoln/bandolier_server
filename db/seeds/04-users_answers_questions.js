  ...
  return knex('users_answers_questions').del()
    .then(function () {
      ...
      return knex('users_answers_questions').insert([
        ...
        {id: 23, user_id: 9, question_id: 1, answer:2},
        {id: 24, user_id: 9, question_id: 2, answer:4},
        {id: 25, user_id: 9, question_id: 3, answer:1},


        {id: 26, user_id: 10, question_id: 1, answer:2},
        {id: 27, user_id: 10, question_id: 2, answer:2},
        {id: 28, user_id: 10, question_id: 3, answer:4},

        {id: 29, user_id: 11, question_id: 1, answer:1},
        {id: 30, user_id: 11, question_id: 2, answer:3},
        {id: 31, user_id: 11, question_id: 3, answer:4},
